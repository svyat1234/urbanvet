      ...
      <Container className="flex items-center justify-between h-full border border-solid border-[#1D1D1D]">
        <div className={` min-w-46 flex items-center h-full justify-center`}>
          <a href="/" className="block w-[7.987rem]">
            <Image src="/images/logo.svg" alt="Logo" width={100} height={100} className='w-full h-auto object-contain'/>
          </a>
        </div>
        ...
        <div className={`flex items-center max-w-[25.375rem] gap-[3.75rem] w-full h-full border-r border-solid border-[#1D1D1D] px-5`}>
          <div className={`flex gap-4`}>
            <a href="" className="block w-[1.625rem] h-[1.625rem] bg-[url('/images/telegram.svg')] bg-no-repeat bg-center bg-contain hover:opacity-50 transition-opacity duration-300"></a>
            <a href="" className="block w-[1.625rem] h-[1.625rem] bg-[url('/images/whatsapp.svg')] bg-no-repeat bg-center bg-contain hover:opacity-50 transition-opacity duration-300"></a>
          </div>
        ...
        <div className={`${styles.searchWrap} min-w-[5.1675rem] h-full flex items-center justify-center border-r border-solid border-[#1D1D1D] px-5`}>
          <button className={`block bg-[url('/images/search.svg')] bg-no-repeat bg-center bg-contain w-[1.41rem] h-[1.41rem] hover:opacity-50 transition-opacity duration-300`}></button>
        </div>
        <div className={`${styles.langWrap} min-w-[5.1675rem] flex items-center justify-center`}>
          <button className={`block bg-[url('/images/burger-menu.svg')] bg-no-repeat bg-center bg-contain w-[1.313rem] h-[1.063rem] hover:opacity-50 transition-opacity duration-300`}></button>
        </div>
      </Container>
    </header>
  );

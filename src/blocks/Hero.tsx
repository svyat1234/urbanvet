    ...
    <section className="pt-[9.625rem] pb-[3.125rem] -mt-[9.625rem] bg-[#F9F9F9]">
      <Container className="flex justify-baseline gap-[20px]">
        ...
        <div className={`flex flex-col gap-[20px] max-w-[798px] w-full`}>
          ...
          >
            <h1 className="font-[Circe] font-bold text-[5.625rem] leading-[90%]">
              {hero.title} <br /> {hero.titleLine2 ?? ''}
            </h1>
            <p className="opacity-50 text-[0.9375rem] leading-[110%] mt-[2.3rem] max-w-[338px]">
              {hero.description}
            </p>
            <CtaButton href={hero.cta.href} label={hero.cta.label} className="mt-[3.8125rem]" />
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col gap-4 max-w-[26.7rem] min-w-0 flex-1  ">
                <h2 className="font-[Circe] font-bold text-[2.5rem] leading-[87%]">{mainDoctor.name}</h2>
            ...
            <Link href={doctorHref(mainDoctor)} className="w-[53px] h-[53px] shrink-0">
